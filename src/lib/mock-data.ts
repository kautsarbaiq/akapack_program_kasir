...
export const mockCategories: Category[] = [
  ...
  { id: 'cat-3', outlet_id: 'outlet-1', name: 'Makanan', color: '#F59E0B', icon: 'Utensils', sort_order: 3, product_count: 15, is_active: true, created_at: '2024-01-01' },
  ...
  { id: 'cat-5', outlet_id: 'outlet-1', name: 'Aksesoris', color: '#EF4444', icon: 'Headphones', sort_order: 5, product_count: 6, is_active: true, created_at: '2024-01-01' },
  { id: 'cat-6', outlet_id: 'outlet-1', name: 'Alat Tulis', color: '#06B6D4', icon: 'Pencil', sort_order: 6, product_count: 9, is_active: true, created_at: '2024-01-01' },
]
